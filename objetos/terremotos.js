...
[ '2015-05-04T18:04:54.320Z, South Georgia and the South Sandwich Islands,5.4,mb,,54,5.654,1.03,us,us20002b8y,2015-05-04T18:23:43.605Z,"21km NNW of Visokoi Island, South Georgia and the South Sandwich Islands",earthquake',
  ...
  function arrayToObj(rawArray) {
    if(Object.prototype.toString.call(rawArray) !== "[object Array]") {
      throw new Error("el parametro no es de tipo array");
    }
	  var occurrences = {};
	  ...
	  return Object.keys(occurrences).map(function(country) {
		  return {text: country, count: occurrences[country]};
	  });
  }
  
  try {
    console.log(arrayToObj(rowData));  
  } catch(e) {
